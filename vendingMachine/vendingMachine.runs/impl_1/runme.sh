...
HD_PWD='C:/projects/vendingMachine/vendingMachine.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TOP_vendingMachine.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TOP_vendingMachine.tcl -notrace
