...
HD_PWD='C:/projects/vendingMachine/vendingMachine.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TOP_vendingMachine.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TOP_vendingMachine.tcl
