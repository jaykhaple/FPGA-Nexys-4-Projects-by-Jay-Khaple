...
module counterSecMinHrMEETOO(outSec,outMin,outHr,clk,rst,set,btnL,btnC,btnR);
...
module digitalClock(cathode,anode,clk,rst,set,btnL,btnC,btnR);
output [6:0]cathode;
output [7:0]anode;
input clk;
input rst,set,btnL,btnC,btnR;
...
counterSecMinHrMEETOO dut02(outSec,outMin,outHr,inCount,rst,set,btnL,btnC,btnR);
...
module TOP_digitalClock(seg,an,led0,led1,RGB1_Red,RGB1_Green,RGB1_Blue,clk,sw0,sw1,btnL,btnC,btnR);
output [6:0]seg;
output [7:0]an;
input clk,sw0,sw1,btnL,btnC,btnR;
output reg led0,led1;
output reg RGB1_Red,RGB1_Green,RGB1_Blue;
digitalClock UUT(seg,an,clk,sw0,sw1,btnL,btnC,btnR);
always@(sw0,sw1,btnL,btnC,btnR)
begin
if(sw0) led0=1;
else led0=0;
if(sw1) led1=1;
