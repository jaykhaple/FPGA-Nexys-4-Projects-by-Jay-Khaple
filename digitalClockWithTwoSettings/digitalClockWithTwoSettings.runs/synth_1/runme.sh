...
HD_PWD='C:/projects/digitalClockWithTwoSettings/digitalClockWithTwoSettings.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TOP_digitalClock.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TOP_digitalClock.tcl
