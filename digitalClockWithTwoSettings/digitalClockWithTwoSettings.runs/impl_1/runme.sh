...
HD_PWD='C:/projects/digitalClockWithTwoSettings/digitalClockWithTwoSettings.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TOP_digitalClock.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TOP_digitalClock.tcl -notrace
