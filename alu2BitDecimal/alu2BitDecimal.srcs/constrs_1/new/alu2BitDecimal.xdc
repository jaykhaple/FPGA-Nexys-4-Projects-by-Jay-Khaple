...
#set_property PACKAGE_PIN U9 [get_ports {num1OrNum2}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {num1OrNum2}]
##Bank = 34, Pin name = IO_25_34,							Sch name = SW1
set_property PACKAGE_PIN U8 [get_ports {swForUnits[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {swForUnits[0]}]
##Bank = 34, Pin name = IO_L23P_T3_34,						Sch name = SW2
set_property PACKAGE_PIN R7 [get_ports {swForUnits[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {swForUnits[1]}]
##Bank = 34, Pin name = IO_L19P_T3_34,						Sch name = SW3
set_property PACKAGE_PIN R6 [get_ports {swForUnits[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {swForUnits[2]}]
##Bank = 34, Pin name = IO_L19N_T3_VREF_34,					Sch name = SW4
set_property PACKAGE_PIN R5 [get_ports {swForUnits[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {swForUnits[3]}]
##Bank = 34, Pin name = IO_L20P_T3_34,						Sch name = SW5
set_property PACKAGE_PIN V7 [get_ports {swForTens[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {swForTens[0]}]
##Bank = 34, Pin name = IO_L20N_T3_34,						Sch name = SW6
set_property PACKAGE_PIN V6 [get_ports {swForTens[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {swForTens[1]}]
##Bank = 34, Pin name = IO_L10P_T1_34,						Sch name = SW7
set_property PACKAGE_PIN V5 [get_ports {swForTens[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {swForTens[2]}]
##Bank = 34, Pin name = IO_L8P_T1-34,						Sch name = SW8
set_property PACKAGE_PIN U4 [get_ports {swForTens[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {swForTens[3]}]
...
set_property PACKAGE_PIN T1 [get_ports {num}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {num}]
##Bank = 34, Pin name = IO_L11P_T1_SRCC_34,					Sch name = SW13
#set_property PACKAGE_PIN R3 [get_ports {sw4[1]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {sw4[1]}]
##Bank = 34, Pin name = IO_L14N_T2_SRCC_34,					Sch name = SW14
#set_property PACKAGE_PIN P3 [get_ports {sw4[2]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {sw4[2]}]
##Bank = 34, Pin name = IO_L14P_T2_SRCC_34,					Sch name = SW15
#set_property PACKAGE_PIN P4 [get_ports {sw4[3]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {sw4[3]}]
...
#set_property PACKAGE_PIN F15 [get_ports mul]						
#	set_property IOSTANDARD LVCMOS33 [get_ports mul] 
##Bank = CONFIG, Pin name = IO_L15N_T2_DQS_DOUT_CSO_B_14,	Sch name = BTNL
#set_property PACKAGE_PIN T16 [get_ports add]    				
#	set_property IOSTANDARD LVCMOS33 [get_ports add]
##Bank = 14, Pin name = IO_25_14,							Sch name = BTNR
#set_property PACKAGE_PIN R10 [get_ports sub]						
#	set_property IOSTANDARD LVCMOS33 [get_ports sub]
##Bank = 14, Pin name = IO_L21P_T3_DQS_14,					Sch name = BTND
#set_property PACKAGE_PIN V10 [get_ports div]    					
