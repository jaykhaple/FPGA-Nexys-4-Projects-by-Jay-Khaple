...
#set_property PACKAGE_PIN U8 [get_ports {sw1[1]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {sw1[1]}]
##Bank = 34, Pin name = IO_L23P_T3_34,						Sch name = SW2
#set_property PACKAGE_PIN R7 [get_ports {sw1[2]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {sw1[2]}]
##Bank = 34, Pin name = IO_L19P_T3_34,						Sch name = SW3
#set_property PACKAGE_PIN R6 [get_ports {sw1[3]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {sw1[3]}]
##Bank = 34, Pin name = IO_L19N_T3_VREF_34,					Sch name = SW4
#set_property PACKAGE_PIN R5 [get_ports {sw2[0]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {sw2[0]}]
##Bank = 34, Pin name = IO_L20P_T3_34,						Sch name = SW5
#set_property PACKAGE_PIN V7 [get_ports {sw2[1]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {sw2[1]}]
##Bank = 34, Pin name = IO_L20N_T3_34,						Sch name = SW6
#set_property PACKAGE_PIN V6 [get_ports {sw2[2]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {sw2[2]}]
##Bank = 34, Pin name = IO_L10P_T1_34,						Sch name = SW7
#set_property PACKAGE_PIN V5 [get_ports {sw2[3]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {sw2[3]}]
##Bank = 34, Pin name = IO_L8P_T1-34,						Sch name = SW8
#set_property PACKAGE_PIN U4 [get_ports {sw3[0]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {sw3[0]}]
##Bank = 34, Pin name = IO_L9N_T1_DQS_34,					Sch name = SW9
#set_property PACKAGE_PIN V2 [get_ports {sw3[1]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {sw3[1]}]
##Bank = 34, Pin name = IO_L9P_T1_DQS_34,					Sch name = SW10
#set_property PACKAGE_PIN U2 [get_ports {sw3[2]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {sw3[2]}]
##Bank = 34, Pin name = IO_L11N_T1_MRCC_34,					Sch name = SW11
#set_property PACKAGE_PIN T3 [get_ports {sw3[3]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {sw3[3]}]
##Bank = 34, Pin name = IO_L17N_T2_34,						Sch name = SW12
#set_property PACKAGE_PIN T1 [get_ports {sw4[0]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {sw4[0]}]
